...
La página y la lógica requiere **PYTHON 3.8.8**, **flask**, **flask_wtf**

El _bot.py_ para testear el tiempo de creación, requiere **PYHTON3.8.8** y **Mechanize**

Existe un _Dockerfile_ para crear una imagen. Ver la seccion de Docker.

### Cómo usar la página:

Al lanzar la pagina, esta despliega un campo de texto y dos botones.

Con el boton _TRANSFORM_, el programa 
